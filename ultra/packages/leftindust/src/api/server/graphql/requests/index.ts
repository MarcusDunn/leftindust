...
export type EditDoctorMutation = { __typename: 'Mutation', editPatient: { __typename: 'Patient', id: { __typename: 'PatientId', value: any } } | undefined };
...
export const EditPatientDocument = { 'kind':'Document','definitions':[{ 'kind':'OperationDefinition','operation':'mutation','name':{ 'kind':'Name','value':'editPatient' },'variableDefinitions':[{ 'kind':'VariableDefinition','variable':{ 'kind':'Variable','name':{ 'kind':'Name','value':'patient' } },'type':{ 'kind':'NonNullType','type':{ 'kind':'NamedType','name':{ 'kind':'Name','value':'EditPatient' } } } }],'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'editPatient' },'arguments':[{ 'kind':'Argument','name':{ 'kind':'Name','value':'patient' },'value':{ 'kind':'Variable','name':{ 'kind':'Name','value':'patient' } } }],'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'id' },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'value' } }] } }] } }] } }] } as unknown as DocumentNode<EditPatientMutation, EditPatientMutationVariables>;
export const EditDoctorDocument = { 'kind':'Document','definitions':[{ 'kind':'OperationDefinition','operation':'mutation','name':{ 'kind':'Name','value':'editDoctor' },'variableDefinitions':[{ 'kind':'VariableDefinition','variable':{ 'kind':'Variable','name':{ 'kind':'Name','value':'editPatient' } },'type':{ 'kind':'NonNullType','type':{ 'kind':'NamedType','name':{ 'kind':'Name','value':'EditPatient' } } } }],'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'editPatient' },'arguments':[{ 'kind':'Argument','name':{ 'kind':'Name','value':'patient' },'value':{ 'kind':'Variable','name':{ 'kind':'Name','value':'editPatient' } } }],'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'id' },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'value' } }] } }] } }] } }] } as unknown as DocumentNode<EditDoctorMutation, EditDoctorMutationVariables>;
