...
export type PatientFragment = { __typename: 'Patient', firstName: string, middleName: string | undefined, lastName: string, dateOfBirth: any, gender: string | undefined, sex: Schema.Sex, thumbnail: any | undefined, insuranceNumber: string | undefined, ethnicity: Schema.Ethnicity | undefined, id: { __typename: 'PatientId', value: any }, addresses: Array<{ __typename: 'Address', address: string, city: string, country: Schema.Countries, postalCode: string, province: string, addressType: Schema.AddressType | undefined, id: { __typename: 'AddressId', value: any } }>, emails: Array<{ __typename: 'Email', email: string, type: Schema.EmailType, id: { __typename: 'EmailId', value: any } }>, phoneNumbers: Array<{ __typename: 'Phone', number: string, type: Schema.PhoneType, id: { __typename: 'PhoneId', value: any } }> };
...
export type SurveyLinkByPatientIdQueryQueryVariables = Schema.Exact<{
  patientIds: Array<Schema.PatientIdInput> | Schema.PatientIdInput;
}>;


export type SurveyLinkByPatientIdQueryQuery = { __typename: 'Query', patientsByPatientId: Array<{ __typename: 'Patient', assignedSurveys: Array<{ __typename: 'SurveyLink', id: { __typename: 'SurveyLinkId', value: any }, completedSurvey: { __typename: 'CompleteSurvey', id: { __typename: 'CompleteSurveyId', value: any }, sections: Array<{ __typename: 'CompleteSurveySection', id: { __typename: 'CompleteSurveySectionId', value: any }, inputs: Array<{ __typename: 'CompleteSurveySectionNumberArrayInput', numberArray: Array<number>, id: { __typename: 'CompleteSurveySectionInputId', value: any } } | { __typename: 'CompleteSurveySectionNumberInput', number: number, id: { __typename: 'CompleteSurveySectionInputId', value: any } } | { __typename: 'CompleteSurveySectionStringArrayInput', stringArray: Array<string>, id: { __typename: 'CompleteSurveySectionInputId', value: any } } | { __typename: 'CompleteSurveySectionStringInput', string: string, id: { __typename: 'CompleteSurveySectionInputId', value: any } }> }>, surveyTemplate: { __typename: 'SurveyTemplate', title: string, subtitle: string | undefined, id: { __typename: 'SurveyTemplateId', value: any }, sections: Array<{ __typename: 'SurveyTemplateSection', title: string, subtitle: string | undefined, calculationId: number, id: { __typename: 'SurveyTemplateSectionId', value: any }, inputs: Array<{ __typename: 'SurveyTemplateInput', calculationId: number, category: Schema.SurveyTemplateCategory | undefined, label: string, options: Array<string> | undefined, placeholder: string | undefined, required: boolean, type: Schema.SurveyTemplateInputType, uploadAccept: Schema.TemplateInputUploadType | undefined, uploadMultiple: boolean | undefined, id: { __typename: 'SurveyTemplateInputId', value: any } }> }>, calculations: Array<{ __typename: 'SurveyTemplateCalculation', calculation: string | undefined, index: number, inputType: Schema.SurveyTemplateInputType | undefined, label: string | undefined, showOnComplete: boolean | undefined, id: { __typename: 'SurveyTemplateCalculationId', value: any } }> } } | undefined, surveyTemplate: { __typename: 'SurveyTemplate', title: string, subtitle: string | undefined, id: { __typename: 'SurveyTemplateId', value: any }, sections: Array<{ __typename: 'SurveyTemplateSection', title: string, subtitle: string | undefined, calculationId: number, id: { __typename: 'SurveyTemplateSectionId', value: any }, inputs: Array<{ __typename: 'SurveyTemplateInput', calculationId: number, category: Schema.SurveyTemplateCategory | undefined, label: string, options: Array<string> | undefined, placeholder: string | undefined, required: boolean, type: Schema.SurveyTemplateInputType, uploadAccept: Schema.TemplateInputUploadType | undefined, uploadMultiple: boolean | undefined, id: { __typename: 'SurveyTemplateInputId', value: any } }> }>, calculations: Array<{ __typename: 'SurveyTemplateCalculation', calculation: string | undefined, index: number, inputType: Schema.SurveyTemplateInputType | undefined, label: string | undefined, showOnComplete: boolean | undefined, id: { __typename: 'SurveyTemplateCalculationId', value: any } }> } }> } | undefined> };
...
export type PatientResolvers<ContextType = any, ParentType extends ResolversParentTypes['Patient'] = ResolversParentTypes['Patient']> = {
  addresses?: Resolver<Array<ResolversTypes['Address']>, ParentType, ContextType>;
  assignedSurveys?: Resolver<Array<ResolversTypes['SurveyLink']>, ParentType, ContextType>;
...
export const CompleteSurveyFragmentFragmentDoc = { 'kind':'Document','definitions':[{ 'kind':'FragmentDefinition','name':{ 'kind':'Name','value':'completeSurveyFragment' },'typeCondition':{ 'kind':'NamedType','name':{ 'kind':'Name','value':'CompleteSurvey' } },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'id' },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'value' } }] } },{ 'kind':'Field','name':{ 'kind':'Name','value':'sections' },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'id' },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'value' } }] } },{ 'kind':'Field','name':{ 'kind':'Name','value':'inputs' },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'id' },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'value' } }] } },{ 'kind':'Field','name':{ 'kind':'Name','value':'id' },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'value' } }] } },{ 'kind':'InlineFragment','typeCondition':{ 'kind':'NamedType','name':{ 'kind':'Name','value':'CompleteSurveySectionNumberArrayInput' } },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'numberArray' } }] } },{ 'kind':'InlineFragment','typeCondition':{ 'kind':'NamedType','name':{ 'kind':'Name','value':'CompleteSurveySectionStringInput' } },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'string' } }] } },{ 'kind':'InlineFragment','typeCondition':{ 'kind':'NamedType','name':{ 'kind':'Name','value':'CompleteSurveySectionStringArrayInput' } },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'stringArray' } }] } },{ 'kind':'InlineFragment','typeCondition':{ 'kind':'NamedType','name':{ 'kind':'Name','value':'CompleteSurveySectionNumberInput' } },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'number' } }] } }] } }] } },{ 'kind':'Field','name':{ 'kind':'Name','value':'surveyTemplate' },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'FragmentSpread','name':{ 'kind':'Name','value':'templateFragment' } }] } }] } }] } as unknown as DocumentNode<CompleteSurveyFragmentFragment, unknown>;
...
export const SurveyLinkByPatientIdQueryDocument = { 'kind':'Document','definitions':[{ 'kind':'OperationDefinition','operation':'query','name':{ 'kind':'Name','value':'surveyLinkByPatientIdQuery' },'variableDefinitions':[{ 'kind':'VariableDefinition','variable':{ 'kind':'Variable','name':{ 'kind':'Name','value':'patientIds' } },'type':{ 'kind':'NonNullType','type':{ 'kind':'ListType','type':{ 'kind':'NonNullType','type':{ 'kind':'NamedType','name':{ 'kind':'Name','value':'PatientIdInput' } } } } } }],'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'patientsByPatientId' },'arguments':[{ 'kind':'Argument','name':{ 'kind':'Name','value':'patientIds' },'value':{ 'kind':'Variable','name':{ 'kind':'Name','value':'patientIds' } } }],'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'Field','name':{ 'kind':'Name','value':'assignedSurveys' },'selectionSet':{ 'kind':'SelectionSet','selections':[{ 'kind':'FragmentSpread','name':{ 'kind':'Name','value':'surveyLinkFragment' } }] } }] } }] } },...SurveyLinkFragmentFragmentDoc.definitions,...CompleteSurveyFragmentFragmentDoc.definitions,...TemplateFragmentFragmentDoc.definitions] } as unknown as DocumentNode<SurveyLinkByPatientIdQueryQuery, SurveyLinkByPatientIdQueryQueryVariables>;
...
export type SurveyLinkByPatientIdQueryQueryStore = OperationStore<SurveyLinkByPatientIdQueryQuery, SurveyLinkByPatientIdQueryQueryVariables>;
