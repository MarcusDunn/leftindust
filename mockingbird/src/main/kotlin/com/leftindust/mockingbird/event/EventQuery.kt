...
class EventQuery(
    ...
    @GraphQLDescription("""Gets a list of events by a list of thier ID's. Will error if any of the ID's us not found.""")
    ...
    @GraphQLDescription("""Gets a list of events by a range of time that returned the events will occur within."""
    )
    ...
    @GraphQLDescription("""Gets a list of events shared by the doctors and patients. ie. all events where both the doctor and the patient attend.""")
