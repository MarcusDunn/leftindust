...
class CompleteSurveyDtoMutationController(
    ...
    suspend fun createCompleteSurvey(@Argument("createCompleteSurvey") createCompleteSurveyDto: CreateCompleteSurveyDto): CompleteSurveyDto? {
        ...
        val completeSurvey = createCompleteSurveyService.createCompleteSurvey(createCompleteSurvey ?: throw InconvertibleDtoException<CreateCompleteSurvey>(createCompleteSurveyDto))
            ?: return null
